                ...
                <table align="center" border="0">
                    <tr>
                        <td>
                            ...
                            <br><br>
                            <input id="radio1" checked type="radio" value="Admin" name="radio"><label
                                for="radio1"><span></span>Admin</label>
                            <br>
                            <input id="radio2" type="radio" value="Manager" name="radio"><label
                                for="radio2"><span></span>Manager</label>
                            <br><br>
                    ...
                    <tr>
                        <td>
                            <select name="AMList">
                                ...
                                %>
                                <option value="<%=ownersList.get(i).getUsername() %>"><%=ownersList.get(i).getUsername()%>
                                </option>
                    ...
                    <tr>
                        <td>
                            <select name="posList">
                                ...
                                %>
                                <option value="<%=positionList.get(i).getName()%>"><%=positionList.get(i).getName() %>
                                </option>
                                <%
                                    }
                                %>
                            ...
                            <select onchange="switchQuestionType()" id="queType" name="queType">
                                ...
                                %>
                                <option value="<%=queTypeList.get(i).getName() %>"><%=queTypeList.get(i).getName()%>
                                </option>
                                <%
                                    }
                                %>
                            ...
                            <input placeholder="Answer1" id="answer1" type="text" name="Answer"><input id="hidden1"
                                                                                                       type="hidden"
                                                                                                       value="false"
                                                                                                       name="Correct"><input
                                onclick="checkboxValidator()" id="checkbox1" type="checkbox" value="true"
                                name="Correct"><label for="checkbox1"><span></span></label><br>
                            <input placeholder="Answer2" id="answer2" type="text" name="Answer"><input id="hidden2"
                                                                                                       type="hidden"
                                                                                                       value="false"
                                                                                                       name="Correct"><input
                                onclick="checkboxValidator()" id="checkbox2" type="checkbox" value="true"
                                name="Correct"><label for="checkbox2"><span></span></label><br>
                            <input placeholder="Answer3" id="answer3" type="text" name="Answer"><input id="hidden3"
                                                                                                       type="hidden"
                                                                                                       value="false"
                                                                                                       name="Correct"><input
                                onclick="checkboxValidator()" id="checkbox3" type="checkbox" value="true"
                                name="Correct"><label for="checkbox3"><span></span></label><br>
                            <input placeholder="Answer4" id="answer4" type="text" name="Answer"><input id="hidden4"
                                                                                                       type="hidden"
                                                                                                       value="false"
                                                                                                       name="Correct"><input
                                onclick="checkboxValidator()" id="checkbox4" type="checkbox" value="true"
                                name="Correct"><label for="checkbox4"><span></span></label><br><br>
                            <button type="submit">ADD</button>
                        </td>
                    </tr>
                </table>
                ...
                <table align="center" border="0">
                    <tr>
                        <td>
                            ...
                            <br>
                            <input placeholder="Nr. of Questions" id="nrQues" class="rowinput2" type="text"
                                   name="nrQue">
                            <br>
                            <button type="submit">ADD</button>
                        </td>
